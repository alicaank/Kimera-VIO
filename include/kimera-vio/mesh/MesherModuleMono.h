...
/**
 * @file   MesherModuleMono.h
 * @brief  Pipeline Module for the Monocular Mesher.
...
class MesherModuleMono : public MIMOPipelineModule<MesherInputMono, MesherOutput> {
 public:
  KIMERA_POINTER_TYPEDEFS(MesherModuleMono);
  KIMERA_DELETE_COPY_CONSTRUCTORS(MesherModuleMono);
  ...
  MesherModuleMono(bool parallel_run, Mesher::UniquePtr mesher);
  virtual ~MesherModuleMono() = default;
 ...
 protected:
  ...
  OutputUniquePtr spinOnce(MesherInputMono::UniquePtr input) override;
